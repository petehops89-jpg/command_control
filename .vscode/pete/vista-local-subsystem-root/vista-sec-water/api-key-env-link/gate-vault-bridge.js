...
async function createGate() {
  ...
  if (!signingKeyPem) {
    ...
    return new GateManager({
      ...
      rateLimiter: new TokenBucketRateLimiter({ maxTokens: 60, refillRate: 10 }),
      allowedReceivers: new Set(['olivia', 'command-portal', 'media-player', 'gem', 'openclaw', 'agent-daemon']),
